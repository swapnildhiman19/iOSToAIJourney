...
```mermaid
gantt
    title Week 1 blog timeline
    dateFormat YYYY-MM-DD
    axisFormat %d %b
    section Hashnode
    Account + setup           :a1, 2026-05-20, 1d
    Draft kickoff post        :a2, 2026-05-20, 1d
    Refine + add screenshots  :a3, 2026-05-23, 1d
    Publish                   :milestone, after a3, 1d
```
