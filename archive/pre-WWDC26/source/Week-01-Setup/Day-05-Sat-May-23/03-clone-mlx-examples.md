...
- [x] `mlx-examples` repo cloned to `~/Desktop/AI/ml-tools/mlx-examples`
- [x] `mlx-env` venv created and activated
- [x] `mlx` and `mlx-lm` installed
- [x] `mx.default_device()` returns `Device(gpu, 0)`
- [x] Random matmul smoke test passes
