...
- [x] **Who I am** — Walmart iOS engineer, X years experience, learning publicly
- [x] **Why I'm switching** — FDE role, why now, what excites me about post-AGI economy
- [x] **The 8-month plan** — Phase 0 → Phase 7 with a one-line theme each
- [x] **What I built in Week 1** — bullet list (the proof from Step 2)
- [x] **What I'll ship per phase** — Doc-Talk, OSS-Docs RAG, Researcher Agent (with rough timelines)
- [x] **Where to follow** — Hashnode RSS, GitHub portfolio link, "DM me if you're hiring FDEs"
- [x] **Disclaimer** — Personal opinions only; not affiliated with my employer
...
- [x] Kickoff blog post is **live** on Hashnode (have the public URL in hand)
- [ ] Cross-posted to Dev.to (if enabled)
- [ ] Shared on LinkedIn at least once
- [x] Saved the URL in `~/Desktop/AI/Week-01-Setup/blog-posts.md` (you'll keep a running log for all 35 weeks)
