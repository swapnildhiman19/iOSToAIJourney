...
- [x] I can explain "declarative vs imperative" infra
- [x] I know what `init` / `plan` / `apply` / `destroy` do
- [x] I understand why `terraform.tfstate` matters
- [x] I can name 3 reasons Terraform beats a Bash script
