...
- [x] Gemma 3 1B downloaded to `~/.cache/huggingface/`
- [x] First generation succeeded with a coherent response
- [x] Streaming variant worked
- [x] I can name the trade-offs vs Gemini 2.5 Flash (4+ axes)
