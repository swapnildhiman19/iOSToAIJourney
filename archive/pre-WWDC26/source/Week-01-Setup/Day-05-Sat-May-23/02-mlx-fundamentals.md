...
- [x] I understand MLX is Apple-Silicon-native and PyTorch-like
- [x] I can explain "unified memory" and why it matters
- [x] I know the difference between MLX, CoreML, and Foundation Models
- [x] I'm ready to clone mlx-examples and download Gemma 3
