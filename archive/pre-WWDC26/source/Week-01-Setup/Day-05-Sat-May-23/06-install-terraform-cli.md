...
- [x] `terraform version` returns 1.9+ on darwin_arm64
- [x] Smoke `terraform init` succeeded with the `hashicorp/google` provider
- [x] `terraform plan` ran cleanly (no changes for an empty config)
- [x] Autocomplete installed (optional)
