...
- [x] I've picked Notion OR Linear (and stopped considering alternatives)
- [x] I understand the three grains: roadmap / weekly / daily
- [x] I accept the 5-min/day overhead
